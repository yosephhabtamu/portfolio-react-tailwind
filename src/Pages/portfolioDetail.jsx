...
const portfolios = [
  ...
  },
  {
    ...
    name: "counter redux",
    description:
      "I used react-redux and redux-toolkit to implement a simple counter that increases its value by one when increment is clicked and decreases by one when decrement is clicked. I have learned how to create store, slice and reducers. I used useDispatch and useSelector hook to manage my state.  ",
    technicalSkills: [
      "React-redux",
      "Redux-toolkit",
      "state management",
    ...
    link: "https://github.com/yosephhabtamu/counter-redux",
  },
];
